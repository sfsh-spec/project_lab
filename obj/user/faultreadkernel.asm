	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800236:	0f be 84 03 65 ee ff 	movsbl -0x119b(%ebx,%eax,1),%eax
  80023d:	ff 
  80023e:	50                   	push   %eax
...
00800286 <vprintfmt>:
{
  ...
  800312:	03 b4 81 f4 ee ff ff 	add    -0x110c(%ecx,%eax,4),%esi
...
008003d5 <.L28>:
  ...
  8003fa:	8d 80 86 ee ff ff    	lea    -0x117a(%eax),%eax
  800400:	50                   	push   %eax
  800401:	57                   	push   %edi
  800402:	56                   	push   %esi
  ...
  800417:	8d 80 7d ee ff ff    	lea    -0x1183(%eax),%eax
  80041d:	50                   	push   %eax
  80041e:	57                   	push   %edi
  80041f:	56                   	push   %esi
...
00800430 <.L24>:
  ...
  800446:	8d 80 76 ee ff ff    	lea    -0x118a(%eax),%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b6b:	8d 83 4c f0 ff ff    	lea    -0xfb4(%ebx),%eax
  800b71:	50                   	push   %eax
  800b72:	6a 23                	push   $0x23
  800b74:	8d 83 69 f0 ff ff    	lea    -0xf97(%ebx),%eax
  800b7a:	50                   	push   %eax
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800bcc:	57                   	push   %edi
  800bcd:	50                   	push   %eax
  800bce:	8d 83 78 f0 ff ff    	lea    -0xf88(%ebx),%eax
  800bd4:	50                   	push   %eax
  ...
  800be1:	e8 32 f5 ff ff       	call   800118 <vcprintf>
	cprintf("\n");
  800be6:	8d 83 9b f0 ff ff    	lea    -0xf65(%ebx),%eax
